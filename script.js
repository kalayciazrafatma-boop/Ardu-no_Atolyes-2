...
const materialData = {
    ...
    "Lehim Pastası": { img: "lehim_pastasi.jpg", desc: "Lehimi kolaylaştıran madde." },
    ...
    "Mikrofon Modülü": { img: "mikrofon_modulu.jpg", desc: "Ses şiddetini algılayan sensör." },
    ...
    "Redüktörlü Motor": { img: "reduktorlu_motor.jpg", desc: "Güçlü hareket sağlayan motor." },
    ...
    "Ses Sensörü": { img: "ses_sensoru.jpg", desc: "Sesi sinyale çevirir." },
...
const projectDatabase = [
    { id: "p1", name: "Bluetooth Araba", required: ["Arduino Uno R3", "HC-06 Bluetooth", "L298N Motor Sürücü", "Redüktörlü Motor", "Tekerlek", "9V Pil"], 
      steps: [
          { img: "https://raw.githubusercontent.com/ArduPED/Arduino/master/Bluetooth_Car/schematic.png", text: "ADIM 1: Motorları şaseye sabitleyin ve Bluetooth modülünü RX-TX pinlerine çapraz bağlayın." },
          { img: "https://i.ibb.co/VWV0pWJ/bluetooth.png", text: "ADIM 2: Motor sürücü bağlantılarını yapıp kodları Arduino'ya yükleyin." }
      ]},
    { id: "p2", name: "Engelden Kaçan Robot", required: ["Arduino Uno R3", "Mesafe Sensörü", "Servo Motor", "L298N Motor Sürücü", "Tekerlek"], 
      steps: [
          { img: "https://raw.githubusercontent.com/ArduPED/Arduino/master/Obstacle_Avoiding_Robot/schematic.png", text: "ADIM 1: Mesafe sensörünü servo üzerine monte edin." },
          { img: "https://i.ibb.co/6X2pYpX/obstacle.png", text: "ADIM 2: Robotun engeli görüp yön değiştirmesi için gerekli algoritmayı çalıştırın." }
      ]},
    { id: "p3", name: "RFID Kapı Sistemi", required: ["Arduino Uno R3", "RFID Kit", "Servo Motor", "LCD Ekran"], 
      steps: [
          { img: "https://raw.githubusercontent.com/m-reza-m/RFID-Door-Lock/master/Images/Schematic.png", text: "ADIM 1: RFID modülünü SPI pinlerine bağlayın." },
          { img: "https://i.ibb.co/kP8G9m3/rfid.png", text: "ADIM 2: Kart tanımlandığında servoyu döndürecek kodu yükleyin." }
      ]},
    { id: "p4", name: "Yangın Alarmı", required: ["Arduino Uno R3", "Alev Sensörü", "Buzzer", "LED"], 
      steps: [
          { img: "https://raw.githubusercontent.com/H0ney-B33/Fire-Alarm-System/master/fire_alarm_schematic.png", text: "ADIM 1: Alev sensöründen analog veri okuyup eşik değerde buzzer'ı tetikleyin." }
      ]},
    { id: "p5", name: "Akıllı Sulama", required: ["Arduino Uno R3", "Nem Kontrol Sensörü", "Su Pompası", "24V Röle"], 
      steps: [
          { img: "https://raw.githubusercontent.com/ashish7sharma/Smart-Irrigation-System/master/schematic.png", text: "ADIM 1: Nem sensörünü toprağa yerleştirin, pompayı röle üzerinden kontrol edin." }
      ]},
    { id: "p6", name: "Ses Kontrollü Işık", required: ["Arduino Uno R3", "Mikrofon Modülü", "24V Röle"], 
      steps: [
          { img: "https://raw.githubusercontent.com/ashishgit7/Arduino-Sound-Sensor/master/Sound_Sensor_Schematic.png", text: "ADIM 1: Mikrofon modülü eşik değeri aştığında röleyi tetikleyin." }
      ]},
    { id: "p7", name: "Joystick Araba", required: ["Arduino Uno R3", "Joystick", "L298N Motor Sürücü", "Tekerlek"], 
      steps: [
          { img: "https://raw.githubusercontent.com/Fisat-Robotics/Joystick-Controlled-Robot/master/Joystick_Robot_Schematic.png", text: "ADIM 1: Joystick verilerine göre motor hızını ve yönünü ayarlayın." }
      ]},
    { id: "p8", name: "IR Kumanda Robot", required: ["Arduino Uno R3", "IR Kumanda Kiti", "L298N Motor Sürücü", "Tekerlek"], 
      steps: [
          { img: "https://raw.githubusercontent.com/V-E-S-T-A/IR-Remote-Control-Car/master/Circuit_Diagram.png", text: "ADIM 1: Uzaktan kumanda kodlarını Arduino'ya tanıtın." }
      ]},
    { id: "p9", name: "Güvenlik Sistemi", required: ["Arduino Uno R3", "PIR Sensör", "Buzzer", "LED"], 
      steps: [
          { img: "https://raw.githubusercontent.com/The-V/Arduino-Security-System/master/Security_System_Schematic.png", text: "ADIM 1: PIR ile hareket algılandığında alarmı aktif edin." }
      ]},
    { id: "p10", name: "Gaz Alarmı", required: ["Arduino Uno R3", "Gaz Sensörü", "Buzzer", "LCD Ekran"], 
      steps: [
          { img: "https://raw.githubusercontent.com/CircuitDigest/Arduino-Gas-Leakage-Detector/master/Gas_Detector_Circuit.png", text: "ADIM 1: Gaz sızıntısı durumunda LCD'de uyarı mesajı gösterin." }
      ]},
    { id: "p11", name: "WiFi Kamera Sistemi", required: ["ESP32-Cam", "PIR Sensör", "9V Pil"], 
      steps: [
          { img: "https://raw.githubusercontent.com/RuiSantosdotme/ESP32-CAM-Projects/master/ESP32-CAM-PIR-Sensor-Photo/Circuit-Diagram.png", text: "ADIM 1: ESP32-Cam ile hareket anında fotoğraf çekip WiFi ile gönderin." }
      ]},
    { id: "p12", name: "Nabız Ölçer", required: ["Arduino Uno R3", "Nabız Sensörü", "LCD Ekran"], 
      steps: [
          { img: "https://raw.githubusercontent.com/Robotistan/Arduino-Dersleri/main/nabiz-sensoru/nabiz-olcer.png", text: "ADIM 1: Nabız verisini parmaktan okuyup LCD ekranda grafikleyin." }
      ]},
    { id: "p13", name: "Akıllı Sera", required: ["Arduino Uno R3", "Nem Kontrol Sensörü", "Yağmur Sensörü", "LCD Ekran"], 
      steps: [
          { img: "https://raw.githubusercontent.com/Smart-Greenhouse/Arduino-Greenhouse/master/Schematic.png", text: "ADIM 1: Sera içi nem ve dış yağmur durumunu anlık takip edin." }
      ]},
    { id: "p14", name: "Saat Sistemi", required: ["Arduino Uno R3", "RTC Saat Modülü", "LCD Ekran"], 
      steps: [
          { img: "https://raw.githubusercontent.com/CircuitDigest/Arduino-RTC-Digital-Clock/master/RTC_Clock_Schematic.png", text: "ADIM 1: Gerçek zamanlı saat verisini çekip LCD'ye yazdırın." }
      ]},
    { id: "p15", name: "Touch Lamba", required: ["Arduino Uno R3", "Touch Pad", "24V Röle"], 
      steps: [
          { img: "https://raw.githubusercontent.com/CircuitDigest/Arduino-Touch-Sensor/master/Touch_Sensor_Schematic.png", text: "ADIM 1: Dokunmatik sensöre her basıldığında rölenin durumunu değiştirin." }
      ]},
    ...
    { id: "p17", name: "Çizgi İzleyen", required: ["Arduino Uno R3", "L298N Motor Sürücü", "Çizgi Sensörü", "Tekerlek"], 
      steps: [
          { img: "https://raw.githubusercontent.com/Robotistan/Arduino-Dersleri/main/cizgi-izleyen/cizgi-izleyen.png", text: "ADIM 1: Sensörleri siyah çizgiyi takip edecek şekilde monte edin." }
      ]},
    { id: "p18", name: "Yüz Tanıma", required: ["ESP32-Cam", "24V Röle", "Servo Motor", "9V Pil"], 
      steps: [
          { img: "https://raw.githubusercontent.com/RuiSantosdotme/ESP32-CAM-Projects/master/ESP32-CAM-Face-Recognition-Door-Lock/Circuit-Diagram.png", text: "ADIM 1: Yüzü tanıyan modül ile kapı kilidini kontrol edin." }
      ]}
];
    ...
    if (!selectedInventory.includes(name)) {
        ...
        itemContainer.innerHTML = `
            <div style="position:relative; text-align:center; cursor:pointer;" onclick="removeFromTable('${name}', this.parentElement)">
                <span style="position:absolute; top:-12px; right:-12px; background:#ff4d4d; color:white; border-radius:50%; width:24px; height:22px; font-size:14px; display:flex; align-items:center; justify-content:center; z-index:100; border:2px solid #fff; font-weight:bold;">×</span>
...
function checkProjects() {
    ...
    if (available.length > 0) {
        linkBox.innerHTML = available.map(p => `<button class="project-btn" onclick="openManual('${p.id}')">${p.name} [GÖSTER]</button>`).join('');
    } else {
